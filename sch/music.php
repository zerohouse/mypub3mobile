...
class ApiManager {
        ...
        private $searchUrl = "http://apis.skplanetx.com/melon/artists?version=1&page=1&count=1&"; // 오픈API 호출URL
        private $target = "book";
        ...
        {
                $url = sprintf("%ssearchKeyword=%s", $this->searchUrl, $query);
