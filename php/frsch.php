...
echo "<li>ID 검색결과</li>";
echo "<li class='frname'> $name_id[0]($id_id[0])님 </a><a class='reqbtn' onclick='friendReq(friend);'>친구요청하기</a></li>";}
...
for ($i=0;$i<$cnt;$i++){
echo "<li><a class='frname'> $name_n[$i]($id_n[$i])님 </a><a class='reqbtn' onclick='friendReq(friend);'>친구요청하기</a></li>";}}
...
for ($i=0;$i<$cnt;$i++){
echo "<li><a class='frname'> $name_p[$i]($id_p[$i])님 </a><a class='reqbtn' onclick='friendReq(friend);'>친구요청하기</a></li>";}}echo "</ul>";
